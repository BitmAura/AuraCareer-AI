...
export const metadata = pageMetadata({
  title: "Privacy",
  description: "AuraCareer AI privacy: account, resume, and hunt data for sovereign career autonomy.",
  path: "/privacy",
});
  ...
  return (
    <MarketingShell>
      ...
      <p className="mt-4 text-[#3d4654]">
        AuraCareer AI stores your account, career targets, resumes, and apply-queue data to run the daily hunt. We do not silent-apply on LinkedIn or Naukri on your behalf.
      </p>
      <p className="mt-4 text-[#3d4654]">
